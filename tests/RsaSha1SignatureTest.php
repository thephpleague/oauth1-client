...
class RsaSha1SignatureTest extends TestCase
{
    ...
    public function testSigningRequest()
    {
        ...
        static::assertEquals('h8vpV4CYnLwss+rWicKE4sY6AiW2+DT6Fe7qB8jA7LSLhX5jvLEeX1D8E2ynSePSksAY48j+OSLu9vo5juS2duwNK8UA2Rtnnvuj6UFxpx70dpjHAsQg6EbycGptL/SChDkxfpG8LhuwX1FlFa+H0jLYXI5Dy8j90g51GRJbj48=', $signature->sign($uri, $parameters));
    }
    ...
    public function testQueryStringFromIndexedArray()
    {
        ...
        static::assertSame('0%3Da%261%3Db', $res);
    }
    ...
    public function testQueryStringFromMultiDimensionalArray()
    {
        ...
        static::assertSame('a[b][c]=d&a[e][f]=g&h=i&empty=&null=&false=', $res);

        // Finally, parse the string back to an array.
        parse_str($res, $original);
    ...
    public function testSigningRequestWithMultiDimensionalParams()
    {
        ...
        static::assertEquals('X9EkmOEbA5CoF2Hicf3ciAumpp1zkKxnVZkh/mEwWyF2DDcrfou9XF11WvbBu3G4loJGeX4GY1FsIrQpsjEILbn0e7Alyii/x8VA9mBwdqMhQVl49jF0pdowocc03M04cAbAOMNObT7tMmDs+YTFgRxEGCiUkq9AizP1cW3+eBo=', $signature->sign($uri, $parameters));
    }
