...
class XingServerTest extends TestCase
{
    ...
    public function testGettingTokenCredentials()
    {
        ...
        $me = $this;
        $client->shouldReceive('post')->with('https://api.xing.com/v1/access_token', m::on(static function ($options) use ($me) {
            $headers = $options['headers'];
    ...
    public function testGettingUserDetails(): void
    {
        ...
        $me = $this;
        $client->shouldReceive('get')->with('https://api.xing.com/v1/users/me', m::on(static function ($options) use ($me) {
            $headers = $options['headers'];
